...
export const DESIGN_TEMPLATES: DesignTemplate[] = [
  {
    ...
    layers: [
      ...
      { type: "text", text: "2026 COLLECTION", fontFamily: "Inter", fontSize: 20, fontWeight: "bold", fill: "#ffffff", left: 140, top: 230, textAlign: "center" }
    ]
  },
  {
    id: "temp-02",
    ...
    layers: [
      ...
      { type: "text", text: "GEN-Z", fontFamily: "Inter", fontSize: 30, fontWeight: "black", fill: "#ffffff", left: 215, top: 310 }
    ]
  },
  {
    id: "temp-03",
  ...
  },
  {
    ...
    layers: [
      ...
      { type: "text", text: "GEN-Z LABS", fontFamily: "Inter", fontSize: 25, fontWeight: "bold", fill: "#39FF14", left: 190, top: 240 }
    ]
  }
];
