          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
              <div className="space-y-4">
                ...
                <Heading size="lg">MISSION: <span className="text-accent italic">{order.stripeSessionId.slice(-10).toUpperCase()}</span></Heading>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="glass-card rounded-[2.5rem] p-10 space-y-8">
                <h3 className="text-xs font-black uppercase tracking-widest text-zinc-500 border-b border-white/5 pb-6">Payload Summary</h3>
                ...
                <div className="pt-6 border-t border-white/5 flex justify-between items-center font-black">
                  <span className="text-[10px] uppercase tracking-widest text-zinc-500">Total Deployment Value</span>
                  <span className="text-xl">${order.totalAmount}.00</span>
                </div>
              </div>

              <div className="glass-card rounded-[2.5rem] p-10 space-y-8">
                <h3 className="text-xs font-black uppercase tracking-widest text-zinc-500 border-b border-white/5 pb-6">Delivery Coordinates</h3>
                <div className="space-y-6">
