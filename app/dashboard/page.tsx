            ...
            <div className="lg:col-span-9 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="glass-card rounded-3xl p-8 border-white/5">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mt-1">Confirmed Deployments</p>
                </div>
              </div>

              {/* Order History */}
              <div className="space-y-6">
                <h3 className="text-xs font-black uppercase tracking-widest text-zinc-500 px-4">Deployment History</h3>
                ...
                {orders.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-12">
                          ...
                          <div className="text-center md:text-right">
                            ...
                            <p className="text-sm font-black mt-1">${order.totalAmount}.00</p>
                          </div>
                  ...
                  <div className="glass-card rounded-[2rem] p-20 text-center space-y-8 border-dashed border-white/10 bg-transparent">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-black uppercase tracking-widest">No deployments detected</p>
                      <p className="text-xs text-zinc-600 font-light">Your order history is currently empty. Start your first mission below.</p>
                    </div>
