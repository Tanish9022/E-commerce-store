# GenZ Collection — Cinematic Custom Streetwear E-commerce

GenZ Collection is a high-performance, visually immersive e-commerce platform built with **Next.js 16**, **Fabric.js**, and **Razorpay**. It features a real-time 2D customization studio, cinematic animations, and a robust administrative backend for managing custom streetwear drops.
